        ...
        return ( 
            ...
            <div>
                ...
                <div className="onboarding2-addName-container">
                    ...
                    <div>
                    {(currentUserBooks.length <3) ? <div className="onboarding2-step-header">Step 2/2 </div>: ''}
                    </div>

                    {(currentUserBooks.length <3) ? <div className="onboading-addName-message">Start with listing three books you own. You can add more books later</div> : ''}  
